;;; emacs-nxs-mode-line.el --- Custom mode-line format and configuration  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-mode-line
  :ensure nil
  :no-require t
  :defer t
  :init
  ;; Shorten big branches names
  (defun emacs-nxs/shorten-vc-mode (vc)
...
Replacing `Git-' with a branch symbol."
  ...
  (setq-default mode-line-format
                '("%e" "  "
                  ...
                  "  "
                  (vc-mode (:eval (emacs-nxs/shorten-vc-mode vc-mode)))
                  "  "
                  mode-line-modes
                  mode-line-misc-info
                  "  ")
  ...
  (defvar emacs-nxs-hidden-minor-modes mode-line-collapse-minor-modes)

  (defun emacs-nxs/purge-minor-modes ()
    (interactive)
    (dolist (x emacs-nxs-hidden-minor-modes nil)
      (let ((trg (cdr (assoc x minor-mode-alist))))
        (when trg
          (setcar trg "")))))

  (if (< emacs-major-version 31)
      (add-hook 'after-change-major-mode-hook 'emacs-nxs/purge-minor-modes)))

(provide 'emacs-nxs-mode-line)
;;; emacs-nxs-mode-line.el ends here
