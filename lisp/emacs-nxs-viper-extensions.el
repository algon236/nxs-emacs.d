;;; emacs-nxs-viper-extensions.el --- Vim-like keybindings and text objects for Viper  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-viper-extensions
  :ensure nil
  :no-require t
  :defer t
  :after viper
...
A compound word includes letters, numbers, `-`, and `_`."
  ...
  (define-key viper-vi-global-user-map (kbd "SPC m p") 'emacs-nxs-formatter/format-current-file-manual)
  ...
  ;; Gutter
  (define-key viper-vi-global-user-map (kbd "] c") 'emacs-nxs/goto-next-hunk)
  (define-key viper-vi-global-user-map (kbd "[ c") 'emacs-nxs/goto-previous-hunk))

(provide 'emacs-nxs-viper-extensions)
;;; emacs-nxs-viper-extensions.el ends here
