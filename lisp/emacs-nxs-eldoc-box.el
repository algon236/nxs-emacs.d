;;; emacs-nxs-eldoc-box.el --- Eldoc documentation in a child frame  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-eldoc-box
  :if emacs-nxs-enable-eldoc-box
  :ensure nil
  :no-require t
  :defer t
  :init
...
(provide 'emacs-nxs-eldoc-box)
;;; emacs-nxs-eldoc-box.el ends here
