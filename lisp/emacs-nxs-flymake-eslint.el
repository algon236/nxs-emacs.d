;;; emacs-nxs-flymake-eslint.el --- Flymake backend for ESLint  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-flymake-eslint
  :if emacs-nxs-enable-flymake-eslint
  :ensure nil
  :no-require t
  :defer t
  :hook
...
(provide 'emacs-nxs-flymake-eslint)
;;; emacs-nxs-flymake-eslint.el ends here
