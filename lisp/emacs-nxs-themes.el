;;; emacs-nxs-themes.el --- Custom color themes based on Modus  -*- lexical-binding: t; -*-
;;
...
(use-package modus-themes
  :if (eq emacs-nxs-use-custom-theme 'catppuccin)
  :ensure nil
  :defer t
  :custom
...
(use-package modus-themes
  :if (eq emacs-nxs-use-custom-theme 'crafters)
  :ensure nil
  :defer t
  :custom
  (modus-themes-italic-constructs t)
...
(use-package modus-themes
  :if (eq emacs-nxs-use-custom-theme 'gits)
  :ensure nil
  :defer t
  :custom
  (modus-themes-italic-constructs t)
...
(use-package modus-themes
  :if (eq emacs-nxs-use-custom-theme 'matrix)
  :ensure nil
  :defer t
  :custom
  (modus-themes-italic-constructs t)
...
;;
;; When no emacs-nxs theme is selected, any faces previously saved to
...
(when (null emacs-nxs-use-custom-theme)
...
(provide 'emacs-nxs-themes)
;;; emacs-nxs-themes.el ends here
