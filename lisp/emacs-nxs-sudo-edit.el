;;; emacs-nxs-sudo-edit.el --- Edit files as root via TRAMP  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-sudo-edit
  :ensure nil
  :no-require t
  :defer t
  :init
  (defun emacs-nxs/sudo-edit (&optional arg)
...
(provide 'emacs-nxs-sudo-edit)
;;; emacs-nxs-sudo-edit.el ends here
