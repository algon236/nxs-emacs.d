;;; emacs-nxs-khard.el --- Khard contacts browser  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-khard
  ...
  (defvar emacs-nxs-khard-buffer "*Khard Contacts*"
    "Buffer name for displaying khard contacts.")

  (defun emacs-nxs--parse-khard-output (output)
  ...
  (define-derived-mode emacs-nxs-khard-mode tabulated-list-mode "Khard"
  ...
  (defun emacs-nxs/khard-list ()
    "Run khard and display contacts in a tabulated buffer."
    (interactive)
    (let* ((output (shell-command-to-string "khard"))
           (entries (emacs-nxs--parse-khard-output output)))
      (with-current-buffer (get-buffer-create emacs-nxs-khard-buffer)
        (emacs-nxs-khard-mode)
        (setq tabulated-list-entries entries)
        (tabulated-list-print t)
        (switch-to-buffer (current-buffer)))))

  (defun emacs-nxs/khard-search ()
...
(provide 'emacs-nxs-khard)
;;; emacs-nxs-khard.el ends here
