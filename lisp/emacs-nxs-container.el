;;; emacs-nxs-container.el --- Container management UI for Docker and Podman  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-container
  :ensure nil
  :no-require t
  :defer t
  :init
...
(provide 'emacs-nxs-container)
;;; emacs-nxs-container.el ends here
