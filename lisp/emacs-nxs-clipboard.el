;;; emacs-nxs-clipboard.el --- System clipboard integration for terminals  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-clipboard
  :ensure nil
  :no-require t
  :defer t
  :init
...
(provide 'emacs-nxs-clipboard)
;;; emacs-nxs-clipboard.el ends here
