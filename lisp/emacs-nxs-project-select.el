;;; emacs-nxs-project-select.el --- Interactive project finder and switcher  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-nxs-project-select
  :ensure nil
  :no-require t
  :init
  (defvar emacs-nxs-default-projects-folder "~/Projects"
    "Default folder to search for projects.")

  (defvar emacs-nxs-default-projects-input ""
    "Default input to use when finding a project.")

  (defun emacs-nxs/find-projects-and-switch (&optional directory)
...
falling back to `find'."
    (interactive)
    (let* ((d (or directory emacs-nxs-default-projects-folder))
           ...
           (initial-input emacs-nxs-default-projects-input))
  ...
  :bind (:map project-prefix-map
              ("P" . emacs-nxs/find-projects-and-switch)))

(provide 'emacs-nxs-project-select)
;;; emacs-nxs-project-select.el ends here
